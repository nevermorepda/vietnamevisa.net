		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 col-xs-6">
				...
				<ul class="fnav-links">
					...
					<li><a title="Visa News" href="<?=site_url("useful-information/{$useful_categories[1]->alias}")?>"><?=$useful_categories[1]->name?></a></li>
					<li><a title="Travel Tips" href="<?=site_url("useful-information/{$useful_categories[2]->alias}")?>"><?=$useful_categories[2]->name?></a></li>
					<li><a title="Consultant Services Guideline" href="<?=site_url("useful-information/{$useful_categories[3]->alias}")?>"><?=$useful_categories[3]->name?></a></li>
				</ul>
			</div>
