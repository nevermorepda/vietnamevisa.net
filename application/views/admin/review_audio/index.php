		...
		<form id="frm-admin" name="adminForm" action="" method="POST">
			...
			<table class="table table-bordered">
				...
				<tr class="row<?=!$item->active?>">
					...
					<td>
						<?=!empty($item->user_id) ? $this->m_user->load($item->user_id)->user_fullname : $item->mail?>
					</td>
					<td>
						<a class="<?=($item->active?"text-color-grey":"")?>" href="<?=site_url("syslog/review-audio/detail/{$item->id}")?>"><?=$item->name?></a>
						<ul class="action-icon-list">
							...
							<? if ($item->active) { ?>
							<li><a href="#" onclick="return itemTask('cb<?=$i?>','unread');"><i class="fa fa-eye" aria-hidden="true"></i> Show</a></li>
							<? } else { ?>
							<li><a href="#" onclick="return itemTask('cb<?=$i?>','read');"><i class="fa fa-eye-slash" aria-hidden="true"></i> Hide</a></li>
							<? } ?>
						</ul>
					</td>
					<td>
