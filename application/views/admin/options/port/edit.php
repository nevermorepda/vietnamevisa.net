		...
		<form id="frm-admin" name="adminForm" action="" method="POST">
			...
			<table class="table table-bordered">
				<tr>
					...
					<td><input type="text" id="airport" name="airport" class="form-control" value="<?=$item->airport?>"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<? foreach ($categories as $arrival_port_category) { ?>
							<option value="<?=$arrival_port_category->id?>"><?=$arrival_port_category->name?></option>
						<? } ?>
						</select>
