			...
			<h1 class="page-title">
				...
				<div class="pull-right">
					<ul class="action-icon-list">
						...
						<li><a href="<?=site_url("syslog/agents/add")?>"><i class="fa fa-plus" aria-hidden="true"></i> Add</a></li>
					</ul>
				</div>
			</h1>
		</div>
		...
		<form id="frm-admin" name="adminForm" action="" method="POST">
			...
			<table class="table table-bordered table-hover">
				...
				<tr class="row<?=$item->active?>">
					...
					<td>
						<a href="<?=site_url("syslog/agents/edit/{$item->id}")?>"><?=$item->name?></a>
						<ul class="action-icon-list">
							<li><a href="<?=site_url("syslog/agents/edit/{$item->id}")?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></li>
