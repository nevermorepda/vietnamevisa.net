					...
					?>
						<li>
							<div class="item clearfix">
								<h2 class="item-head"><a title="<?=$item->title?>" href="<?=site_url("news/travel/view/{$item->alias}")?>"><?=$item->title?></a></h2>
								<?=$item->summary?>
								<span class="right"><a title="Read more" class="btn btn-danger" href="<?=site_url("news/travel/view/{$item->alias}")?>">Read more »</a></span>
							</div>
						</li>
						<?	} ?>
					</ul>
